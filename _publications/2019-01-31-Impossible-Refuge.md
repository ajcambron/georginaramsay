...
category: books
image: impossiblerefuge.jpg
header:
  # This is a banner image that shows only on the page(e.g., the banner image)
  # image: 500x300.png
  
  # This image is ONLY used for the social media preview (og:image)
  og_image: impossiblerefuge.jpg
...
---
<figure>
    <img src='/images/impossiblerefuge.jpg' alt='book cover' height='200'/>
